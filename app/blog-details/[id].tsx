...
export default function BlogDetails() {
    ...
    const blogPost = blogData.find((post) => post.id === parseInt(id as string));
                        ...
                        <div className="col-lg-8">
                            <div className="blog__details-wrap mb-100">
                                <div className="blog__details-thumb">
                                    ...
                                    <div className="blog__post-meta">
                                        <ul className="list-wrap">
                                            <li><i className="far fa-user" /><Link href="#">{blogPost.author}</Link></li>
                                ...
                                <div className="blog__details-content">
                                    ...
                                    <p className="mb-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                                    ...
                                    <blockquote>
                                        <p>KK Printing has been an invaluable partner to us. Their deep understanding of stationery and office supplies needs allows them to seamlessly integrate with our team and meet the level of quality that we hold ourselves accountable to. </p>
                                    </blockquote>
                                    ...
                                    <div className="inner__page-nav pt-30">
                                        <Link href="#" className="nav-btn text-md-end">
                                            <div className="text-wrap mb-0">
                                                ...
                                                <span>VIEW PREVIOUS POST</span>
                                            </div>
                                        </Link>
                                        <Link href="#" className="nav-btn">
                                            <div className="text-wrap mb-0">
                                                <span>VIEW NEXT POST</span>
                                ...
                                <form action="#" className="comment-form">
                                    ...
                                    <div className="row gy-35">
                                        ...
                                        <div className="col-12 form-group">
                                            ...
                                            <textarea name="message" placeholder="Message*" id="contactForm" className="form-control style-border"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div className="rc-post-wrap">
                                        <div className="rc-post-item">
                                            ...
                                            <div className="content">
                                                <h4 className="title"><Link href="/blog-details">A GLIMPSE INTO MY CREATIVE PORTFOLIO</Link></h4>

            ...
            <div className="accordion-area accordion" id="faqAccordion">
                <div className="accordion-card active">
                    <div className="accordion-header" id="collapse-item-1" onClick={() => handleClick(1)}>
                        <button  className={isActive.key == 1 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1"><span className="accordion-number">01</span> What will my Project cost?</button>
                    </div>
                ...
                <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-2" onClick={() => handleClick(2)}>
                        <button  className={isActive.key == 2 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2"><span className="accordion-number">02</span>What happens to my data if I cancel?</button>
                    </div>
                ...
                <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-3" onClick={() => handleClick(3)}>
                        <button  className={isActive.key == 3 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3"><span className="accordion-number">03</span>How I can optimize voice search?</button>
                    </div>
                ...
                <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-4" onClick={() => handleClick(4)}>
                        <button  className={isActive.key == 4 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4"><span className="accordion-number">04</span>What happens to my data if I cancel?</button>
                    </div>
                ...
                <div className="accordion-card">
                    <div className="accordion-header" id="collapse-item-5" onClick={() => handleClick(5)}>
                        <button  className={isActive.key == 5 ? "accordion-button" : "accordion-button collapsed"} type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5"><span className="accordion-number">05</span>Can I change my plan later?</button>
                    </div>

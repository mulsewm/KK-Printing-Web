...
export default function Header3({ scroll, isMobileMenu, handleMobileMenu, isOffcanvasMenu, handleOffcanvasMenu }: any) {
    return (
        <>
            <header>
                <div id="sticky-header" className={`tg-header__area transparent-header tg-header__area-three ${scroll ? "sticky-menu" : ""}`}>

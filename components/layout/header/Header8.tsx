...
export default function Header8({ scroll, isMobileMenu, handleMobileMenu, isOffcanvasMenu, handleOffcanvasMenu }: any) {
    return (
        <>
            <header>
            <div id="sticky-header" className={`tg-header__area transparent-header  tg-header__area-eight ${scroll ? "sticky-menu" : ""}`}>

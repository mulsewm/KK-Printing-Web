...
export default function Header5({ scroll, isMobileMenu, handleMobileMenu, isOffcanvasMenu, handleOffcanvasMenu }: any) {
    return (
        <>
            <header>
            <div id="sticky-header" className={`tg-header__area transparent-header  tg-header__area-five ${scroll ? "sticky-menu" : ""}`}>
